...
public interface HumanResource {
    ...
    public HolidayResponse holiday(@WebParam(partName = "HolidayRequest", name = "HolidayRequest", targetNamespace = "http://exercise3.wdsr/hr/schemas") HolidayRequest holidayRequest);
}
